...
class XingYe(AbstractLoader):
    ...
    normal_flow = {
        ...
        'trade_price': ['成交价格', '成交均价', '成交均价港币', '成交价格港币', ],
        'trade_volume': ['成交数量', '发生数量', ],
        'trade_amount': ['成交金额', '成交金额港币', ], 'trade_status': ['成交状态', '状态说明', ],
        # 'trade_name': ['业务名称', ],
        None: [
            '成交编号', '委托编号', '股东代码', '合同编号', '申报编号', '交易市场', '成交日期', '资金账户', '成交类型', '资金账户',
            '资金帐户',
        ]
    }
    ...
    option_flow = {
        ...
        'trade_name': ['成交类型', ],
        'trade_tag': ['备兑', ],
        None: ['类别', '委托号', '成交编号', '交易市场', '期权交易代码', '委托属性'],
    }
